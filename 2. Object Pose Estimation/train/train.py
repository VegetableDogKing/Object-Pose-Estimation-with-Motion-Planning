...
Example usage:
 ...
 python -m torch.distributed.launch --nproc_per_node=1 train/train.py --data button_data --object valve --outf output/handle/weights
"""
...
parser.add_argument(
    "--batchsize", "--batch_size", type=int, default=50, help="input batch size"
)
parser.add_argument(
    "--imagesize",
    type=int,
