...
class CleanVisiiDopeLoader(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        for obj in data_json["objects"]:
            if "label" in obj and obj["label"] == self.objects_interest[0]:
            ...
            elif "class" in obj and obj["class"] == self.objects_interest[0]:
                # load the projected_cuboid_keypoints
                if obj["visibility"] > 0:
        ...
        transform = A.Compose(
            [
                ...
                A.GaussNoise(p=1, var_limit=(10.0, 200.0)),
            ],
